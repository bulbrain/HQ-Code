...
namespace CohesionAndCoupling
{
    class Examples
    {
        static void Main()
        {
            ...
            Console.WriteLine("Volume = {0:f2}", Calculator.CalcVolume());
            Console.WriteLine("Diagonal XYZ = {0:f2}", Calculator.CalcDiagonalXYZ());
            Console.WriteLine("Diagonal XY = {0:f2}", Calculator.CalcDiagonalXY());
            Console.WriteLine("Diagonal XZ = {0:f2}", Calculator.CalcDiagonalXZ());
            Console.WriteLine("Diagonal YZ = {0:f2}", Calculator.CalcDiagonalYZ());
            Console.ReadLine();
        }
    }
}
